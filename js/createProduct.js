...
const createProduct = (data) => { 
    ...
    <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <span class="price">lei${data.sellPrice}</span>
                    <span class="actual-price">lei${data.actualPrice}</span>
                </div>
            </div>
...
const deleteItem = (id) => {
    ...
    .then(data => {
        if(data == 'success'){
            ...
            showAlert('some error occurred while deleting this product. Try again');
        }
    })
}